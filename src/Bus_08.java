...
public class Bus_08 extends Thread{
        ...
        while(activo == true){
            ...
            if (Tiempo.Horas_Contador >= 5){
                ...
                if (label_bus_destacado == false){
                    Interfaz_Grafica.label_bus08.setIcon(new ImageIcon(Interfaz_Grafica.imgbus8));
                    Interfaz_Grafica.label_bus08.setLocation(locacion_X , locacion_Y);
                }
                else if (label_bus_destacado == true){
                    Interfaz_Grafica.label_bus08.setIcon(new ImageIcon(Interfaz_Grafica.imgbus8G));
                    Interfaz_Grafica.label_bus08.setLocation(locacion_X , locacion_Y);
                }
                    ...
                    if (evitar_estacion == false){
                        num_estacion = 1;
                            nom_estacion = "Ciudad Deportiva Rafael Angel Perez";
                                if (Bus_07.num_estacion == num_estacion && Bus_07.num_estacion > 0 && num_estacion > 0){ 
                                    Bus_07.evitar_estacion = true;
                                }
