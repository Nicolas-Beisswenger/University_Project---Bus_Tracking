...
public class Bus_10 extends Thread{
        ...
        while(activo == true){
            ...
            if (Tiempo.Horas_Contador >= 5){
                ...
                if (label_bus_destacado == false){
                    Interfaz_Grafica.label_bus10.setIcon(new ImageIcon(Interfaz_Grafica.imgbus10));
                    Interfaz_Grafica.label_bus10.setLocation(locacion_X , locacion_Y);
                }
                else if (label_bus_destacado == true){
                    Interfaz_Grafica.label_bus10.setIcon(new ImageIcon(Interfaz_Grafica.imgbus10G));
                    Interfaz_Grafica.label_bus10.setLocation(locacion_X , locacion_Y);
                }
                    ...
                    if (evitar_estacion == false){
                        num_estacion = 1;
                            nom_estacion = "Ciudad Deportiva Rafael Angel Perez";
                                if (Bus_09.num_estacion == num_estacion && Bus_09.num_estacion > 0 && num_estacion > 0){ 
                                    Bus_09.evitar_estacion = true;
                                }
