...
public class Bus_02 extends Thread{
        ...
        while(activo == true){
            ...
            if (Tiempo.Horas_Contador >= 5){
                ...
                if (label_bus_destacado == false){
                    Interfaz_Grafica.label_bus02.setIcon(new ImageIcon(Interfaz_Grafica.imgbus2));
                    Interfaz_Grafica.label_bus02.setLocation(locacion_X , locacion_Y);
                }
                else if (label_bus_destacado == true){
                    Interfaz_Grafica.label_bus02.setIcon(new ImageIcon(Interfaz_Grafica.imgbus2G));
                    Interfaz_Grafica.label_bus02.setLocation(locacion_X , locacion_Y);
                }
                    ...
                    if (evitar_estacion == false){
                        num_estacion = 1;
                            nom_estacion = "Ciudad Deportiva Rafael Angel Perez";
                                if (Bus_01.num_estacion == num_estacion && Bus_01.num_estacion > 0 && num_estacion > 0){ 
                                    Bus_01.evitar_estacion = true;
                                }
...
//Volver a la estacion --------------------------------------------------------------------------------            
            ...
            /*else if (locacion_X == acceso_infoestaciones.X_RestLaFortuna && locacion_Y == acceso_infoestaciones.Y_RestLaFortuna){
                System.out.println("Son las "+ Tiempo.Horas_Contador);
                System.out.println("Bus 2 detenido");
            }
            else{
                try {
