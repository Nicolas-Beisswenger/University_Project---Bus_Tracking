...
public class Bus_09 extends Thread{
        ...
        while(activo == true){
            ...
            if (Tiempo.Horas_Contador >= 5){
                ...
                if (label_bus_destacado == false){
                    Interfaz_Grafica.label_bus09.setIcon(new ImageIcon(Interfaz_Grafica.imgbus9));
                    Interfaz_Grafica.label_bus09.setLocation(locacion_X , locacion_Y);
                }
                else if (label_bus_destacado == true){
                    Interfaz_Grafica.label_bus09.setIcon(new ImageIcon(Interfaz_Grafica.imgbus9G));
                    Interfaz_Grafica.label_bus09.setLocation(locacion_X , locacion_Y);
                }
                    ...
                    if (evitar_estacion == false){
                        num_estacion = 1;
                            nom_estacion = "Ciudad Deportiva Rafael Angel Perez";
                                if (Bus_08.num_estacion == num_estacion && Bus_08.num_estacion > 0 && num_estacion > 0){ 
                                    Bus_08.evitar_estacion = true;
                                }
