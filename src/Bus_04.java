...
public class Bus_04 extends Thread{
        ...
        while(activo == true){
            ...
            if (Tiempo.Horas_Contador >= 5){
                ...
                if (label_bus_destacado == false){
                    Interfaz_Grafica.label_bus04.setIcon(new ImageIcon(Interfaz_Grafica.imgbus4));
                    Interfaz_Grafica.label_bus04.setLocation(locacion_X , locacion_Y);
                }
                else if (label_bus_destacado == true){
                    Interfaz_Grafica.label_bus04.setIcon(new ImageIcon(Interfaz_Grafica.imgbus4G));
                    Interfaz_Grafica.label_bus04.setLocation(locacion_X , locacion_Y);
                }
                    ...
                    if (evitar_estacion == false){
                        num_estacion = 1;
                            nom_estacion = "Ciudad Deportiva Rafael Angel Perez";
                                if (Bus_03.num_estacion == num_estacion && Bus_03.num_estacion > 0 && num_estacion > 0){ 
                                    Bus_03.evitar_estacion = true;
                                }
